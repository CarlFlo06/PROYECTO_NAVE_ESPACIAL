...
namespace NaveEspacial
{
    internal class Ventana
    {
        ...
        public void CrearBalas()
        {
            ...
            _balas.Add(bala9);
            Bala bala10 = new Bala(new Point(0, 0), ConsoleColor.DarkCyan, TipoBala.Menu);
            _balas.Add(bala10);
            Bala bala11 = new Bala(new Point(0, 0), ConsoleColor.DarkGray, TipoBala.Menu);
            _balas.Add(bala11);
            Bala bala12 = new Bala(new Point(0, 0), ConsoleColor.DarkGreen, TipoBala.Menu);
            _balas.Add(bala12);
            Bala bala13 = new Bala(new Point(0, 0), ConsoleColor.Blue, TipoBala.Menu);
            _balas.Add(bala13);
            Bala bala14 = new Bala(new Point(0, 0), ConsoleColor.Green, TipoBala.Menu);
            _balas.Add(bala14);
            ...
            for (int i = 0; i < _balas.Count; i++)
            {
                ...
                int numeroAletorio = random.Next(LimiteSuperior.Y + 1, LimiteInferior.Y);
                _balas[i].Posicion = new Point(_balas[i].Posicion.X, numeroAletorio);
            }
        }
